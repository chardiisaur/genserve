...
function mapApiJob(j: Record<string, unknown>): ServiceJob {
  return {
    ...
    clientName: (j.clientName as string) || (j.clientId as string) || '',
    siteId: (j.siteId as string) || '',
    siteName: (j.siteName as string) || (j.siteId as string) || '',
    generatorId: (j.generatorId as string) || '',
    generatorName: (j.generatorName as string) || (j.generatorId as string) || '',
    ...
    leadTechnicianName: (j.leadTechnicianName as string) || (j.leadTechnicianId as string) || '',
    additionalTechnicianName: (j.additionalTechnicianName as string) || undefined,
